...
public abstract class AutoPowerShots extends LinearOpMode {
    ...
    public double targetSpacing = 7.5;
    public double[] startToWobbleX = {2 * inchPerFoot, 0, 2 * inchPerFoot};
    public double[] startToWobbleY = {9 * inchPerFoot, 7 * inchPerFoot, 5 * inchPerFoot};
    public double startToParkX = inchPerFoot;
    ...
    public void runOpMode() {
        ...
        // drop wobble goal
        encoderDrive(startToWobbleX[ringCount] - startToShootX - targetSpacing * 2, startToWobbleY[ringCount] - startToShootY);
        encoderLowerArm();
